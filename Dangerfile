...
message('[html coverage report](https://circleci.com/api/v1/project/ENV['CIRCLE_PROJECT_USERNAME']/ENV['CIRCLE_PROJECT_REPONAME']/ENV['CIRCLE_BUILD_NUM']/artifacts/0/$CIRCLE_ARTIFACTS/htmlcov/index.html)')